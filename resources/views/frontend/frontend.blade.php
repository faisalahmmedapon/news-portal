                            ...
                            <div class="single-slider">
                                <div class="trending-top mb-30">
                                    <div class="trend-top-img">
                                        <img src="{{asset('frontend')}}/assets/img/trending/trending_top2.jpg" alt="">
                                        ...
                                        <div class="col-xl-6 col-lg-12">
                                            <div class="whats-news-single mb-40 mb-40">
                                                <div class="whates-img">
                                                    <img src="{{asset('frontend')}}/assets/img/gallery/whats_news_details1.png" alt="">
                                                </div>
                                        ...
                                        <div class="col-xl-6 col-lg-12">
                                            <div class="row">
                                                ...
                                                <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                                    <div class="whats-right-single mb-20">
                                                        <div class="whats-right-img">
                                                            <img src="{{asset('frontend')}}/assets/img/gallery/whats_right_img1.png" alt="">
                                                        </div>
                                                ...
                                                <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                                    <div class="whats-right-single mb-20">
                                                        <div class="whats-right-img">
                                                            <img src="{{asset('frontend')}}/assets/img/gallery/whats_right_img2.png" alt="">
                                                        </div>
                                                        <div class="whats-right-cap">
                                                            <span class="colorb">FASHION</span>
                                                            <h4><a href="latest_news.html">Portrait of group of friends ting eat. market in.</a></h4>
                                                ...
                                                <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                                    <div class="whats-right-single mb-20">
                                                        <div class="whats-right-img">
                                                            <img src="{{asset('frontend')}}/assets/img/gallery/whats_right_img3.png" alt="">
                                                        </div>
                                                        <div class="whats-right-cap">
                                                ...
                                                <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                                    <div class="whats-right-single mb-20">
                                                        <div class="whats-right-img">
                                                            <img src="{{asset('frontend')}}/assets/img/gallery/whats_right_img4.png" alt="">
                                                        </div>
                                                        <div class="whats-right-cap">
                    ...
                    <div class="most-recent-area">
                        ...
                        <div class="most-recent mb-40">
                            <div class="most-recent-img">
                                <img src="{{asset('frontend')}}/assets/img/gallery/most_recent.png" alt="">
                        ...
                        <div class="most-recent-single">
                            <div class="most-recent-images">
                                <img src="{{asset('frontend')}}/assets/img/gallery/most_recent1.png" alt="">
                            </div>
                        ...
                        <div class="most-recent-single">
                            <div class="most-recent-images">
                                <img src="{{asset('frontend')}}/assets/img/gallery/most_recent2.png" alt="">
                            </div>
                            <div class="most-recent-capt">
                                    ...
                                    <div class="weekly2-news-active d-flex">
                                        ...
                                        <div class="weekly2-single">
                                            <div class="weekly2-img">
                                                <img src="{{asset('frontend')}}/assets/img/gallery/weeklyNews1.png" alt="">
                                            </div>
                                        ...
                                        <div class="weekly2-single">
                                            <div class="weekly2-img">
                                                <img src="{{asset('frontend')}}/assets/img/gallery/weeklyNews2.png" alt="">
                                            </div>
                                            <div class="weekly2-caption">
                                                <h4><a href="#">Scarlett’s disappointment at latest accolade</a></h4>
                                                <p>Jhon  |  2 hours ago</p>
                                        ...
                                        <div class="weekly2-single">
                                            <div class="weekly2-img">
                                                <img src="{{asset('frontend')}}/assets/img/gallery/weeklyNews3.png" alt="">
                                            </div>
                                            <div class="weekly2-caption">
                                                <h4><a href="#">Scarlett’s disappointment at latest accolade</a></h4>
                                                <p>Jhon  |  2 hours ago</p>
                    ...
                    <div class="col-12">
                        <div class="recent-active dot-style d-flex dot-style">
                            ...
                            <div class="single-recent">
                                <div class="what-img">
                                    <img src="{{asset('frontend')}}/assets/img/gallery/tranding1.png" alt="">
                                </div>
                                <div class="what-cap">
                            ...
                            <div class="single-recent">
                                <div class="what-img">
                                    <img src="{{asset('frontend')}}/assets/img/gallery/tranding2.png" alt="">
                                </div>
                                <div class="what-cap">
                ...
                <div class="col-12">
                    <div class="video-items-active">
                        <div class="video-items text-center">
                            <video controls>
                                <source src="{{asset('frontend')}}/assets/video/news2.mp4" type="video/mp4">
                                Your browser does not support the video tag.
                            </video>
                        </div>
                        <div class="video-items text-center">
                            <video controls>
                                <source src="{{asset('frontend')}}/assets/video/news1.mp4" type="video/mp4">
                                Your browser does not support the video tag.
                            </video>
                        </div>
                        <div class="video-items text-center">
                            <video controls>
                                <source src="{{asset('frontend')}}/assets/video/news3.mp4" type="video/mp4">
                                Your browser does not support the video tag.
                            </video>
                        </div>
                        <div class="video-items text-center">
